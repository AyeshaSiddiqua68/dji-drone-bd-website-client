  ...
  const onSubmit = async (data) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch("https://secret-stream-74331.herokuapp.com/addProduct", {
          method: "POST",
            ...
            <Row className="justify-content-center">
              <Form.Group as={Col} md={6} sm={12} className="mr-md-5">
                ...
                <Form.Control
                  ...
                  placeholder="Enter new product's title"
                />
              </Form.Group>
            ...
            <Row>
              <InputGroup as={Col} className="mb-3 mt-md-3">
                ...
                <FormControl
                  ...
                  type="text"
                  {...register("img")}
                  placeholder="Enter new product's image"
                />
              </InputGroup>
            </Row>
            <Row>
